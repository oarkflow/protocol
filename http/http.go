...
// DefaultSprayingClient DefaultClient returns a new http.Client with similar default values to
...
// DefaultClient DefaultPooledClient returns a new http.Client with similar default values to
